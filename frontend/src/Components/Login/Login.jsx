...
function Login() {
    ...
    return (
        <div>
            ...
            <section style={{backgroundImage: "url('../../../Images/homepage_bg.jpg')"}} className="bg-cover w-full h-screen mx-auto text-center flex flex-col justify-center items-center">
                {/* Background Image */}
